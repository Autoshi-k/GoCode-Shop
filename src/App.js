...
function App() {
  ...
  // const categories = itemsInfo.map(item => item.category).filter((value, index, array) => array.indexOf(value) === index);

  // const [filtered, setFiltered] = useState("men's clothing");
  // const handleFilter = (e) => {
  //   setFiltered(categories[e.target.selectedIndex]);
  // }
